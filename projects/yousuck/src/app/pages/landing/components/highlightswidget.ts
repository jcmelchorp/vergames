  ...
  template: `
    <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
      ...
      <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
        ...
        >
          <img
            src="https://static.vecteezy.com/system/resources/thumbnails/024/656/738/small/man-with-red-flag-in-hand-makes-victory-gesture-showing-leadership-qualities-and-motivating-people-png.png"
            class="w-11/12"
            alt="mockup mobile"
          />
        </div>
      ...
      <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
        ...
        >
          <img
            src="https://cdni.iconscout.com/illustration/premium/thumb/man-talking-on-phone-illustration-download-in-svg-png-gif-file-formats--call-logo-mobile-male-people-talk-use-pack-illustrations-8264682.png"
            class="w-11/12"
            alt="mockup"
          />
        </div>
