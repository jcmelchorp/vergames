  ...
  template: `
    <div class="card">
      ...
      <p class="text-lg mb-4">
        U&nbsp;suck is an application template for Angular and is distributed as
        a CLI project. Current versions is Angular v19 with PrimeNG v19. In case
...
ng serve</code></pre>
      ...
      <p class="text-lg mb-4">
        ...
        separated so that you can easily identify what is necessary for your
        application.
      </p>
      <ul class="leading-normal list-disc pl-8 text-lg mb-4">
        ...
        <li>
          <span class="text-primary font-medium">src/assets/demo</span>: Assets
          used in demos
        </li>
        <li>
      ...
      <p class="text-lg mb-4">
        CSS variables used in the template are derived from the applied PrimeNG
