...
@Component({
  ...
  template: `
    <svg:g>
      <ng-container *ngIf="eye.key == 'Circle'">
        <ellipse
          cx="168.117"
          cy="167.927"
          rx="9"
      ...
      <ng-container *ngIf="eye.key == 'Oval'">
        <ellipse
          cx="168.53"
          cy="168.402"
          rx="9"
      ...
      <ng-container *ngIf="eye.key == 'Smile'">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
      ...
      <ng-container *ngIf="eye.key == 'Shadow'">
        <circle
          cx="167.24"
          cy="159.239"
          r="12"
