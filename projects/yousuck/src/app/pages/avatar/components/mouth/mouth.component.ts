...
import { Mouth } from '../../avatar.types';
...
@Component({
  ...
  template: `
    <svg:g>
      <ng-container *ngIf="mouth.key == 'Frown'">
        <path
      ...
      <ng-container *ngIf="mouth.key == 'Laughing'">
        <path
      ...
      <ng-container *ngIf="mouth.key == 'Nervous'">
        <rect
          x="173.248"
          y="220.471"
          width="70"
      ...
      <ng-container *ngIf="mouth.key == 'Pucker'">
        <path
      ...
      <ng-container *ngIf="mouth.key == 'Sad'">
        <path
      ...
      <ng-container *ngIf="mouth.key == 'Smile'">
        <path
      ...
      <ng-container *ngIf="mouth.key == 'Smirk'">
        <path
      ...
      <ng-container *ngIf="mouth.key == 'Suprised'">
        <path
