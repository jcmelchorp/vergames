...
import { Earring, Ear } from '../../avatar.types';
...
@Component({
  ...
  template: `
    <svg:g>
      <ng-container *ngIf="ear.key == 'Small' && earring.key == 'Hoop'">
        <path
      ...
      <ng-container *ngIf="ear.key == 'Small' && earring.key == 'Stud'">
        <circle cx="122" cy="211" r="4" fill="#846700" />
        <circle cx="123" cy="210" r="1" fill="#FFEDEF" />
      </ng-container>

      <ng-container *ngIf="ear.key == 'Big' && earring.key == 'Hoop'">
        <path
      ...
      <ng-container *ngIf="ear.key == 'Big' && earring.key == 'Stud'">
        <circle cx="115" cy="216" r="4" fill="#846700" />
