...
import { Glasses } from '../../avatar.types';
...
@Component({
  ...
  template: `
    <svg:g>
      <ng-container *ngIf="glasses.key == 'Round'">
        <circle cx="234.5" cy="159" r="26" stroke="black" stroke-width="4" />
        <circle cx="167.5" cy="168" r="26" stroke="black" stroke-width="4" />
        <path
      ...
      <ng-container *ngIf="glasses.key == 'Square'">
        <path
