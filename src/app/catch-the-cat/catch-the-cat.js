!(function (t) {
            ...
            return (
                    ...
                    set: function (t) {
                        switch (t) {
                            ...
                            case i.LOSE:
                                this.setStatusText(
                                    f.default(
                                        "El gato ha corrido hasta el borde del mapa, pierdes"
                                    )
                                );
                                break;
                            case i.WIN:
                                this.setStatusText(
                                    f.default(
                                        "El gato no tiene camino a seguir, tú ganas"
                                    )
                                );
                                break;
                            default:
                ...
                (e.prototype.playerClick = function (t, e) {
                    if (
                        ...
                        return (
                            this.setStatusText(
                                f.default(
                                    "El juego ha terminado, comienza de nuevo"
                                )
                            ),
                            this.reset(),
                            !1
                    ...
                    return n
                        ? n.isWall
                            ? (this.setStatusText(
                                  f.default(
                                      "La ubicación del clic ya es un muro, el clic está prohibido"
                                  )
                              ),
                              !1)
                            ...
                            ? (this.setStatusText(
                                  f.default(
                                      "La posición del clic es la posición actual del gato, el clic está prohibido"
                                  )
                              ),
                              !1)
                            : ((n.isWall = !0),
                              this.cat.isCaught()
                                  ...
                                  : (this.setStatusText(
                                    ...
                                    this.cat.step() ||
                                        (this.setStatusText(
                                            f.default(
                                                "¡El gato admite la derrota y tú ganas!"
                                            )
                                        ),
                                        (this.state = i.WIN)),
                                    !0))
                        : (this.setStatusText(
                              f.default(
                                  "Error de código, la posición actual no existe"
                              )
                          ),
                          !1);
                }),
                (e.prototype.reset = function () {
                    this.cat.reset(),
                        ...
                        this.setStatusText(
                            f.default(
                                "Haz clic en los puntos para rodear al gatito."
                            )
                        );
                }),
    ...
    function (t, e, n) {
        ...
        var i = n(0),
            s = (function (t) {
                function e(e) {
                    var n = this;
                    e.credit || (e.credit = "github.com/jcmelchorp"),
                    ...
                    return (
                        ((n = t.call(this, u) || this).myConfig = e),
                        (n.mainScene = h),
                        n
                    );
                }
         ...
         * Catch The Cat Game
         *
         * https://github.com/juliomelchorpinto
         */ e.default = s;
    },
    function (t, e) {
        t.exports =
            ...
            l = (function (t) {
                ...
                return (
                    ...
                    (e.prototype.isCaught = function () {
                        var t = this;
                        return !this.getCurrentNeighbours().some(function (
                            e,
                            n
                        ) {
                    ...
                    (e.prototype.runForward = function () {
                        this.play(
                            s.default.directions[this.direction].name + "_run"
                        );
                    }),
        ...
        var i = (function (t) {
            function e(e, n, o, r) {
                var i = this,
                    s = e.getPosition(n, o);
                ((i =
                    t.call(this, e, s.x, s.y, r, 0, 360, !1, 0, 1) ||
                    this).i = n),
                    (i.j = o),
                    (i.r = r),
                    (i.isWall = !1);
    ...
    function (t, e, n) {
        ...
        var i = n(2),
            s = (function (t) {
                function e(e) {
                    var n =
                        t.call(this, e, 0, 0, i.default("↩️ Reiniciar"), {}) ||
                        this;
                    n.setColor("#000000");
                    var o = e.r;
                    n.setFontSize(1.2*o),
                    ...
                    return (
                        n.setInteractive(r, Phaser.Geom.Rectangle.Contains),
                        n.setFontFamily("Roboto"),
                        n
                    );
                }
                return r(e, t), e;
            ...
            function e(e) {
                ...
                return (
                    ...
                    "center" === e.game.myConfig.statusBarAlign &&
                        (n.setX(e.game.canvas.width / 2), n.setOrigin(0.5, 0.6)),
                    n.setPadding(o, o, o, o),
                    n.setFontFamily("Roboto"),
                    n
                );
    ...
    function (t, e, n) {
        ...
        var i = (function (t) {
            function e(e) {
                var n = t.call(this, e, 0, 0, "2025 © Pete Sahatt", {}) || this;
                n.setColor("#000000"),
        ...
        var d = {
            ...
            abort: function () {
                (this.aborted = !0),
                    ...
                    this.readyState > l.UNSENT &&
                        this.sendFlag &&
                        (this._readyStateChange(l.UNSENT),
                        (this.sendFlag = !1)),
